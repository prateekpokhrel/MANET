        ...
        <div className="auth-page">
            <section className="auth-visual">
                ...
                <div className="visual-content">
                    ...
                    <p>
                        Secure node management and
                        communication for your mobile
                        ad-hoc network.
                    </p>
                </div>

                <div
                    className={`topology topology-${networkState}`}
                >
                        ...
                        <div className="access-screen">
                            ...
                            <div className="security-note">
                                ...
                                <div>
                                    ...
                                    <span>
                                        Only registered nodes can
                                        join the MANET network.
                                    </span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="admin-warning">
                                ...
                                <div>
                                    ...
                                    <span>
                                        ...
                                        before a new node can be registered.
                                    </span>
                                </div>
                            </div>
